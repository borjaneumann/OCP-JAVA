...
public class _03_NamedModules {
    ...
    a JAR containing a module‐info file is on the classpath. For now, just
    ...
    module‐info file and is on the module path. Figure 17.1 shows the
    contents of a JAR file for a named module. It contains two packages in
    addition to the module‐info.class.
