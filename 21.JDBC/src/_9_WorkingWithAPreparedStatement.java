public class _9_WorkingWithAPreparedStatement {
    /*
    ...
    Security: As you will see in Chapter 22, “Security,” you are protected
    against an attack called SQL injection when using a PreparedStatement
    correctly.

    Readability: It's nice not to have to deal with string concatenation in
    building a query string with lots of parameters.

    Future use: Even if your query is being run only once or doesn't have any
